#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR TECH-CLOUD V5\033[0m"
...
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/sincpainel.zip > /dev/null 2>&1
