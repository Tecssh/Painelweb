...
exit;
  ...
  echo -e 'by: @tecssh' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/ppweb/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/ppweb/verifatt.sh > /dev/null 2>&1
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/ppweb/verpweb > /dev/null 2>&1
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/ppweb/verweb > /dev/null 2>&1
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/ppweb/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/Tecssh/Painelweb/raw/main/painelwv5/gestorssh.zip > /dev/null 2>&1
...
function pconf { 
sed "s/1010/$pwdroot/" /var/www/html/pages/system/pass.php > /tmp/pass
mv /tmp/pass /var/www/html/pages/system/pass.php

}
function inst_db { 
sed -i "s;dominio;$IP;g" /var/www/html/sshplus.sql > /dev/null 2>&1
sleep 1
if [[ -e "/var/www/html/sshplus.sql" ]]; then
    mysql -h localhost -u root -p"$pwdroot" --default_character_set utf8 sshplus < /var/www/html/sshplus.sql > /dev/null 2>&1
    rm /var/www/html/sshplus.sql > /dev/null 2>&1
else
    clear
...
echo ""
echo -e "WEB TECH-CLOUD" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @cloudtechnetwork\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://github.com/Tecssh/Painelweb/raw/main/painelwv5/chave") &>/dev/null
...
echo -e "PAINEL WEB TECH-CLOUD" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @cloudtechnetwork\033[1;36m" | lolcat
echo ""
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@cloudtechnetwork\033[0m" | lolcat
echo ""
